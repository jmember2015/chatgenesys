...
<head>
    ...
    <link href="assets/css/bootstrap.css?v=1.04" rel="stylesheet"/>
...
<script src="assets/js/sockjs.min.js?v=1.03"></script>
<script src="assets/js/stomp.min.js?v=1.04"></script>
<script src="assets/js/chat.js?v=1.05"></script>
</body>
</html>
